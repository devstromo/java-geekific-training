...
/**
 * From <a href="https://algs4.cs.princeton.edu/code/edu/princeton/cs/algs4/BTree.java.html">BTree</a>
 * @param <Key>
 * @param <Value>
 */
            ...
            for (int j = 0; j < h.m; j++) {
                if (j > 0)
                    builder.append(indent)
                        ...
                        .append(children[j].key)
                        .append(")\n");
                builder.append(toString(children[j].next, ht - 1, indent + "     "));
            }
        }
